  ...
  mainPanel(
    ...
    tabsetPanel(
      ...
      tabPanel(
        ...
        p("- after pushing the 'Predict the next word!' button the most likely following word is predicted and the conditional probability of correctness of the prediction, given the inputted phrase and given 'static' n-grams based on provided datasets, is returned"),
